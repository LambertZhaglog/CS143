...
public:
   ...
   virtual void buildPass(CgenClassTableP env)=0;
   virtual void generateInit(ostream& s,CgenClassTableP env)=0;
   virtual void generateMethod(ostream& s,CgenClassTableP env)=0;
