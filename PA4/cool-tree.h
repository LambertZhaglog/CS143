...
public:
   ...
   virtual void inheritPass(ClassTableP env)=0;
   virtual void scopePass(ClassTableP env)=0;
...
public:
   ...
   virtual bool inheritInit(ClassTableP env)=0;
   virtual bool inheritPass(ClassTableP env)=0;
   virtual void scopePass(ClassTableP env)=0;
...
public:
   ...
   virtual Symbol scopePass(ClassTableP env)=0;
...
public:
   ...
   void inheritPass(ClassTableP env);
   void scopePass(ClassTableP env);
...
public:
   ...
   Class_ copy_Class_();
   void dump(ostream& stream, int n);
   bool inheritInit(ClassTableP env);
   bool inheritPass(ClassTableP env);
   void scopePass(ClassTableP env);
...
public:
   ...
   Case copy_Case();
   void dump(ostream& stream, int n);
   Symbol scopePass(ClassTableP env);
   Symbol getType();
